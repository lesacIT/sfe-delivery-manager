...
class BannerSettingView extends StatefulWidget {
  const BannerSettingView({super.key});

  @override
  State<BannerSettingView> createState() => _BannerSettingViewState();
}

class _BannerSettingViewState extends State<BannerSettingView> {
